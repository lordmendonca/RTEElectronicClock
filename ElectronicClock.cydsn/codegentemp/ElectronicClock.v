...
module top ;
    ...
    defparam UART_LOG.EnIntRXInterrupt = 1;
	...
	wire [0:0] tmpOE__Rx_LOG_net;
	wire [0:0] tmpIO_0__Rx_LOG_net;
	wire [0:0] tmpINTERRUPT_0__Rx_LOG_net;
	electrical [0:0] tmpSIOVREF__Rx_LOG_net;
	...
	cy_psoc3_pins_v1_10
		...
		Rx_LOG
		 (.oe(tmpOE__Rx_LOG_net),
		  .y({1'b0}),
		  .fb({Net_67}),
		  .io({tmpIO_0__Rx_LOG_net[0:0]}),
		  .siovref(tmpSIOVREF__Rx_LOG_net),
		  .interrupt({tmpINTERRUPT_0__Rx_LOG_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Rx_LOG_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Tx_LOG_net;
	wire [0:0] tmpFB_0__Tx_LOG_net;
	wire [0:0] tmpIO_0__Tx_LOG_net;
	wire [0:0] tmpINTERRUPT_0__Tx_LOG_net;
	electrical [0:0] tmpSIOVREF__Tx_LOG_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("ed092b9b-d398-4703-be89-cebf998501f6"),
		  ...
		  .input_buffer_sel(2'b00))
		Tx_LOG
		 (.oe(tmpOE__Tx_LOG_net),
		  .y({Net_71}),
		  .fb({tmpFB_0__Tx_LOG_net[0:0]}),
		  .io({tmpIO_0__Tx_LOG_net[0:0]}),
		  .siovref(tmpSIOVREF__Tx_LOG_net),
		  .interrupt({tmpINTERRUPT_0__Tx_LOG_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Tx_LOG_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("90513de8-abba-4365-9d3d-7b62281d0054"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("a29e1bb4-b276-432a-b065-53db612a4de2"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("c20a990c-c3ba-4fd6-ab6f-d0f3eb64bc0d"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("d38b2914-7a7b-43a8-9827-377c063c0d9c"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    SPI_Master_v2_50_2 TFT_SPI (
        ...
        .mosi(wTFT_SDA),
        .reset(1'b0),
        .rx_interrupt(Net_841),
        .sclk(wTFT_SCL),
        .sdat(Net_842),
        .ss(Net_843),
        .tx_interrupt(Net_844));
