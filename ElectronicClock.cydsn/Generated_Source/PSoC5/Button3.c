...
*
* \funcusage
*  \snippet Button3_SUT.c usage_Button3_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet Button3_SUT.c usage_Button3_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet Button3_SUT.c usage_Button3_Read  
*******************************************************************************/
...
* preferred Button3_Read() API because the 
* Button3_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet Button3_SUT.c usage_Button3_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: Button3_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use Button3_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - Button3_0_INTR       (First pin in the list)
    *  - Button3_1_INTR       (Second pin in the list)
    *  - ...
    *  - Button3_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet Button3_SUT.c usage_Button3_SetInterruptMode
    *******************************************************************************/
    void Button3_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & Button3_0_INTR) != 0u) 
		{ 
			 Button3_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet Button3_SUT.c usage_Button3_ClearInterrupt
    *******************************************************************************/
